...
layout: post
category : lessons
tagline: "Lecture Notes from Ken Robinson's Ted Talk"
tags : [intro, beginner, education, tutorial]
---
{% include JB/setup %}

Below is an excerpt from a conversation between a 4 year old student and his teacher during a drawing class!

    Teacher: What are you doing?
    Student: I am drawing "God"!
    Teacher: But no one knows how God looks like!
    Student: They will, in a moment

What is interesting above is a quality that you would observe in almost any kid! If they do not know something, they will take a guess at it!

Unless of course you then tell them repeatedly that they are wrong and they should not try 


I have always believed that the education system is this methodical approach of killing creativity and one's passion for something. I did always felt very strongly about it and after so many reviews and 
reports that I read in the last few months about creativity it is time we change it. 

## Overview 

Even though I have a lot to say about the undergraduate education in this post I will primarily write about the school education.

### Mistake 1: We compare them with each other.

A normal Indian Classroom has about 60 students. They study a variety of subjects each carefully and meticulously designed to kill creativity. Chapters follow some sort of order possibly chronological
and filled with informations like dates and names of rulers in history to collection of formulae for mathematics. Now in order to complete the Indian High School and the primary school it is thus imperative
that one is familiar with all such informations and it is thus the accepted norm to forget all these interesting bits of History and Geography when one joins their undergraduate school.

### The undergraduate school: A study of a specific college

One of the beter known college of the country the Birla Institute of Technology and Science, Pilani boasts of many achievemnts in areas of humanities and engineering.
With decent facilities of both extra curriculars and labs the college in Goa comprises of roughly about 2500 undergraduates and about 50 Masters and PhD candidates.
The institute is located right on the NH17B Highway and the campus is beautiful. The cricket fields are mainatined with collaboration with the BCCI and the you can often find Goa 
State level matches in the football fields.

Now when everything seems really good lets talk about the not so important part of the college: the engineering disciplines. I am from Information Systems and though 
a lot of the things I am about to say applies to both Information Systems and Computer Science.
